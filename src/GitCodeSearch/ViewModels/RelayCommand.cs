...
public class SelfCancelledCommand(Func<CancellationToken, Task> action, Func<bool>? canExecute = null)
    : RelayCommand(action, canExecute)
{
    public override bool CanExecute(object? parameter)
    {
        return canExecute_?.Invoke() != false;
    }
...
public class RelayCommand : ICommand, INotifyPropertyChanged
{
    ...
    protected readonly Func<bool>? canExecute_;
